...
public class MappingController {
    ...
    //@RequestMapping(value = {"/hello-basic", "/hello-basic-sub"}, method = RequestMethod.GET)
    @GetMapping("/hello-basic")
    public String helloBasic() {
        log.info("hello basic Controller started");
        return "ok";
    }
